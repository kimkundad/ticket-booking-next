        ...
        axios.post(`${process.env.API}/addOrder`, { user }).then(
            response => {
                ...
                if (response.status === 200) {
                    ...
                    router.push('/succesPayment?orderId=' + response.data.order_id);
                ...
                <div className={styles.card}>
                    ...
                    <div className={styles.paymentButtonContainer}>
                        {checkErrorRe === false ?
                            ...
                            :
                            <Link href={{ pathname: `/seats/${movieId}`, query: { seats: isTimerCompleted ? null : JSON.stringify(seats) } }}><button type="button" className="btn btn-secondary">กลับไปเลือกที่นั่งใหม่</button></Link>
                        }
