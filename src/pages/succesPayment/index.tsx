            ...
            <div className={styles.container}>
                ...
                <div className={styles.cardTitleContainer}>
                    ...
                    <div className={'image-container-pay'}>
                        <Image src="/S__5562374.jpg" layout="fill" className={'image-pay'} />
                    </div>
                    {isLoading ?
                        <div>loading...</div>
                        :
                    <Link href={{ pathname: `/paymentNoti`, query: { ordercon: order?.data_order.order_id } }}><button type="button" className="btn btn-danger mt-15">แจ้งการชำระเงิน</button></Link>
}
